...
export function scoreAssessment(form){
  ...
  if(service!=='Guestroom PM'){
    ...
    return{property_category:category,readiness_score:Math.max(0,Math.min(100,score)),recommended_program:isHeavy?rec.heavy:rec.standard,estimated_rooms_per_day:null,recommended_pricing:rec.pricing,recommended_crew:rec.crew};
  }
